...
const Beautypage = () => {
  ...
  const getData = (page, sort) => {
    ...
    axios
      .get(
        `https://json-server-craftsvilla.vercel.app/beauty?_limit=12&_page=${page}&_sort=price&_order=${sort}`
      )
  ...
  const Carthandler = (e) => {
    ...
    axios
      .post(
        `http://https://json-server-craftsvilla.vercel.app/beauty/Cartproducts`,
        AddnewItem
      )
      .then(e);
  };
